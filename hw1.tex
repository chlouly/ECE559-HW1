...
\begin{enumerate}[label=(\alph*)]
    \item   Show that the sequence $x_k = 1 + \left(\frac{1}{2}\right)^{2^k}$ is Q-quadratically convergent to 1. \newline
            ...
            \begin{align*}
                \norm{1 + \left(\frac{1}{2}\right)^{2^k} - 1}_2 &\geq \gamma \norm{1 + \left(\frac{1}{2}\right)^{2^{k-1}} - 1}_2^2 \\
                \left(\frac{1}{2}\right)^{2^k} &\geq \gamma \left[\left(\frac{1}{2}\right)^{2^{k-1}}\right]^2\\
                \left(\frac{1}{2}\right)^{2^k} &\geq \gamma \left(\frac{1}{2}\right)^{2^{k}}
            \end{align*}
